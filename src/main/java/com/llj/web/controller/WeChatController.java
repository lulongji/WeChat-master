...
import com.llj.web.utils.WeChatUtil;
import com.llj.web.utils.WeiXinResponseMessage;
...
public class WeChatController {
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/demoProcess", produces = "application/json;charset=UTF-8")
    ...
    public WeiXinResponseMessage sendMsg(@RequestBody String requestBody, HttpServletRequest request) {
        WeiXinResponseMessage resp = new WeiXinResponseMessage();
        boolean result;
        JSONObject jsonObject = JSONObject.parseObject(requestBody);
        String msg = jsonObject.getString("msg");
        String openid = jsonObject.getString("openid");
        String resultMsg = "请求成功：msg:" + msg + ",openid=" + openid;
        try {
            result = WeChatUtil.sendTextMessageToUser(msg, openid);
            if (!result) {
                resultMsg = "请求发送失败！msg:" + msg + ",openid=" + openid;
                resp.setSuccess(false);
                resp.setMessage(resultMsg);
